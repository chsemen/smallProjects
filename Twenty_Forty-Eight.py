...
def getNewBoard():
    ...
    # Loop over every possible space and set all the tiles blank:
    for x in range(4):
        for y in range(4):
            newBoard[(x,y)] = BLANK

    # Pick two random for the two starting 2s:
...
def drawBoard(board):
    ...
    for y in range(4):
        for x in range(4):
            ...
            labelForThisTils = str(tile).center(5)
            labels.append(labelForThisTils)
...
def getScore(board):
    """Returns the sum of all tiles on the board data structure."""
    score = 0
...
def combineTilesInColumn(column):
    ...
    for i in range(3):  # Skip index 3: it's the topmost space.
        if combinedTiles[i] == combinedTiles[i + 1]:
            ...
            # Move the tiles above it down ont space:
...
def makeMove(board, move):
    ...
    # depending on the direction move:
    if move == 'W':
        allColumnSpaces = [[(0, 0), (0, 1), (0, 2), (0, 3)],
                           [(1, 0), (1, 1), (1, 2), (1, 3)],
                           [(2, 0), (2, 1), (2, 2), (2, 3)],
                           [(3, 0), (3, 1), (3, 2), (3, 3)]]
    elif move == 'A':
        allColumnSpaces = [[(0, 0), (1, 0), (2, 0), (3, 0)],
                           [(0, 1), (1, 1), (2, 1), (3, 1)],
                           [(0, 2), (1, 2), (2, 2), (3, 2)],
                           [(0, 3), (1, 3), (2, 3), (3, 3)]]
    elif move == 'S':
        allColumnSpaces = [[(0, 3), (0, 2), (0, 1), (0, 0)],
                           [(1, 3), (1, 2), (1, 1), (1, 0)],
                           [(2, 3), (2, 2), (2, 1), (2, 0)],
                           [(3, 3), (3, 2), (3, 1), (3, 0)]]
    elif move == 'D':
        allColumnSpaces = [[(3, 0), (2, 0), (1, 0), (0, 0)],
                           [(3, 1), (2, 1), (1, 1), (0, 1)],
                           [(3, 2), (2, 2), (1, 2), (0, 2)],
                           [(3, 3), (2, 3), (1, 3), (0, 3)]]
    ...
    boardAfterMove = {}
    for columnSpaces in allColumnSpaces:  # Loop over all 4 column.
...
def askForPlayerMove():
    """Asks the player for the direction of their next move (or quie).

    Ensures they enter a valid move: either 'W', 'A', 'S' or 'D'."""
    print('Enter move: (WASD of Q to quit)')
