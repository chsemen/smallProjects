...
"""A labeled seven-segment display, with each segment labeledd A to G:
 __A__
|     |    
...
if __name__ == '__main__':
    ...
    print('|__|    | |__ ')
    print()
    print('Display the numbers 00 to 99')
    for i in range(100):
        # myNumber = getSevSegStr(str(i)+'.1', 4)
